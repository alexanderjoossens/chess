...
TEST_CASE_PSEUDO_MOVES("Pseudo-legal pawn moves, en enpassant_index, black left", "[Pawn][EnPassant]") {
    testPseudoLegalMoves(
...
TEST_CASE_PSEUDO_MOVES("Pseudo-legal pawn moves, en enpassant_index, black right", "[Pawn][EnPassant]") {
    testPseudoLegalMoves(
...
TEST_CASE_PSEUDO_MOVES("Pseudo-legal pawn moves, en enpassant_index, white left", "[Pawn][EnPassant]") {
    testPseudoLegalMoves(
...
TEST_CASE_PSEUDO_MOVES("Pseudo-legal pawn moves, en enpassant_index, white right", "[Pawn][EnPassant]") {
    testPseudoLegalMoves(
...
TEST_CASE_PSEUDO_MOVES("Pseudo-legal pawn moves, en enpassant_index, black both", "[Pawn][EnPassant]") {
    testPseudoLegalMoves(
...
TEST_CASE_PSEUDO_MOVES("Pseudo-legal pawn moves, en enpassant_index, white both", "[Pawn][EnPassant]") {
    testPseudoLegalMoves(
...
TEST_CASE_PSEUDO_MOVES("Pseudo-legal pawn moves, en enpassant_index, wrong square", "[Pawn][EnPassant]") {
    testPseudoLegalMoves(
...
TEST_CASE_PSEUDO_MOVES("Pseudo-legal pawn moves, visual en enpassant_index, no square", "[Pawn]") {
    testPseudoLegalMoves(
...
TEST_CASE_MAKE_MOVE("Move making, en enpassant_index, black left", "[EnPassant]") {
...
TEST_CASE_MAKE_MOVE("Move making, en enpassant_index, black right", "[EnPassant]") {
...
TEST_CASE_MAKE_MOVE("Move making, en enpassant_index, white left", "[EnPassant]") {
...
TEST_CASE_MAKE_MOVE("Move making, en enpassant_index, white right", "[EnPassant]") {
...
TEST_CASE_MAKE_MOVE("Move making, en enpassant_index square, white double step update", "[EnPassant]") {
...
TEST_CASE_MAKE_MOVE("Move making, en enpassant_index square, black double step update", "[EnPassant]") {
...
TEST_CASE_MAKE_MOVE("Move making, en enpassant_index square, remove after capture", "[EnPassant]") {
...
TEST_CASE_MAKE_MOVE("Move making, en enpassant_index square, remove after move", "[EnPassant]") {
